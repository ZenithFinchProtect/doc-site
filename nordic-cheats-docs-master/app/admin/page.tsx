          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full h-11 rounded-xl border border-primary/20 bg-background/60 px-4 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full h-11 rounded-xl border border-primary/20 bg-background/60 px-4 pr-11 text-sm outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
